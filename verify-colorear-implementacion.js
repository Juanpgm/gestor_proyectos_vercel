...
const mapFile = path.join(__dirname, 'src', 'components', 'UnidadesProyectoMapSimple.tsx');
...
const checks = [
  ...
  },
  {
    ...
    verified: mapContent.includes("{ value: 'tipo_equipamiento', label: 'Tipo de Equipamiento' }")
  },
  {
    name: 'Switch case para tipo_equipamiento en coloración',
    verified: mapContent.includes("case 'tipo_equipamiento':\n            field = 'tipo_equipamiento';")
  },
  {
...
if (allPassed) {
  ...
  log('  2. Haz clic en el botón "Colorear por" (esquina superior derecha)', 'white');
