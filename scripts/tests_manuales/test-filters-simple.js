...
async function testAPI() {
  ...
  try {
    ...
    log(
      '   1. La API devuelve "comunas" NO "comunas_corregimientos"',
      "yellow"
    );
    log(
      '   2. Los años vienen como strings: "2024.0", "2025.0", "2026.0"',
      "yellow"
    );
    log("   3. tipos_equipamiento tiene 22 valores únicos", "yellow");
    log(
      '   4. Algunos barrios tienen valores extraños como fechas: "2025-05-01"',
      "red"
    );
