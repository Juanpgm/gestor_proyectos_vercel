...
import { X, Upload, AlertCircle, CheckCircle, Plus, Trash2, Edit2, FileText, ChevronDown } from 'lucide-react'
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                {contratoData?.referencia_contrato && (
                  <p className="text-indigo-100 text-sm">Contrato: {contratoData.referencia_contrato}</p>
                )}
              </div>
            </div>
            <button
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-gray-50 dark:bg-gray-700/50">
                        <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">N° RPC</th>
                        <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Beneficiario</th>
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {rpcsExistentes.map((rpc) => (
                        <tr key={rpc.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                          <td className="px-3 py-2 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                            {rpc.numero_rpc}
                          </td>
                          <td className="px-3 py-2 text-gray-600 dark:text-gray-300 truncate max-w-[160px]" title={rpc.beneficiario_nombre}>
            ...
            {rpcsExistentes.length > 0 && (
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-500 dark:text-gray-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 flex items-center gap-1.5 transition-colors">
                  ...
                  Nuevo RPC
                  <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${showNuevoRPCForm ? 'rotate-180' : ''}`} />
                </span>
                <div className="flex-1 border-t border-gray-200 dark:border-gray-700 group-hover:border-indigo-300 dark:group-hover:border-indigo-600 transition-colors"></div>
              </button>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                  ...
                  Documentos de Soporte <span className="text-red-500 ml-1">*</span>
                </h3>
