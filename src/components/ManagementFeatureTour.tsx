  ...
  procesos: [
    {
      ...
      description: 'Aquí confirmas el contexto del módulo y tienes acceso rápido para volver al dashboard principal.'
    },
    {
      selector: '[data-tour-id="mgmt-procesos-tabs"]',
      title: 'Pestañas de origen',
      description: 'Cambia entre SECOP, Tienda Virtual y Convenios para analizar el origen de los procesos.'
    },
    {
      selector: '[data-tour-id="mgmt-procesos-stats"]',
      title: 'Indicadores clave',
      description: 'Este bloque resume volumen, valores y cobertura para priorizar seguimiento de forma inmediata.'
    },
    {
      selector: '[data-tour-id="mgmt-procesos-filters"]',
      title: 'Filtros y acciones',
      description: 'Desde aquí aplicas búsqueda, controlas columnas y ejecutas acciones operativas como actualizar o crear procesos.'
    },
    {
      selector: '[data-tour-id="mgmt-procesos-table"]',
      title: 'Tabla de procesos',
      description: 'Es la vista de detalle para auditoría y trazabilidad de cada proceso contractual.'
    }
  ],
  contratos: [
    {
      ...
      title: 'Encabezado del módulo',
      description: 'Muestra el alcance de gestión contractual y el acceso rápido para regresar al panel principal.'
    },
    {
      selector: '[data-tour-id="mgmt-contratos-stats"]',
      title: 'KPIs de contratos',
      description: 'Resume cantidad, ejecución financiera y distribución para detectar focos de gestión.'
    },
    {
      selector: '[data-tour-id="mgmt-contratos-filters"]',
      title: 'Búsqueda y filtros',
      description: 'Permite filtrar, ordenar y preparar la vista para revisión operativa o validación documental.'
    },
    {
  ...
  pagos: [
    {
      ...
      description: 'Aquí validas el alcance del módulo y accedes de vuelta al dashboard general.'
    },
    {
      selector: '[data-tour-id="mgmt-pagos-tabs"]',
      title: 'Vista por tipo',
      description: 'Alterna entre RPCs y pagos para navegar entre origen de obligación y ejecución.'
    },
    {
      selector: '[data-tour-id="mgmt-pagos-stats"]',
      title: 'Indicadores financieros',
      description: 'Monitorea montos, saldos y volumen para identificar estado global de pago.'
    },
    {
      selector: '[data-tour-id="mgmt-pagos-filters"]',
      title: 'Búsqueda y control',
      description: 'Usa filtros y actualización de datos para auditar rápidamente la información de pagos.'
    },
    {
      selector: '[data-tour-id="mgmt-pagos-table"]',
      title: 'Tabla operativa',
      description: 'Revisa los registros para análisis transaccional y validación de soporte.'
    }
  ],
  unidades: [
    {
      ...
      description: 'Identifica el módulo de calidad de datos y sus acciones rápidas.'
    },
    {
      selector: '[data-tour-id="mgmt-unidades-filters"]',
      title: 'Panel de filtros',
      description: 'Permite acotar por centro gestor, severidad, prioridad y búsqueda de texto.'
    },
    {
      selector: '[data-tour-id="mgmt-unidades-tabs"]',
      title: 'Secciones analíticas',
      description: 'Navega entre resumen, registros, historial y estadísticas sin salir del módulo.'
    },
    {
      selector: '[data-tour-id="mgmt-unidades-content"]',
      title: 'Área de resultados',
      description: 'Visualiza resultados y detalle operativo según la pestaña activa.'
    }
  ],
  usuarios: [
    {
      ...
      description: 'Presenta el contexto de administración de usuarios y controles principales del módulo.'
    },
    {
      selector: '[data-tour-id="mgmt-usuarios-stats"]',
      title: 'Métricas de usuarios y roles',
      description: 'Este bloque resume volumen y distribución de roles para seguimiento de gobernanza.'
    },
    {
      selector: '[data-tour-id="mgmt-usuarios-filters"]',
      title: 'Filtros de consulta',
      description: 'Filtra por texto, rol, centro gestor y estado para encontrar casos rápidamente.'
    },
    {
      selector: '[data-tour-id="mgmt-usuarios-table"]',
      title: 'Listado de usuarios',
      description: 'Desde esta tabla gestionas acciones sobre usuarios según tus permisos.'
    }
  ]
}
...
const ManagementFeatureTour: React.FC<ManagementFeatureTourProps> = ({ moduleKey, highestRole, userId }) => {
