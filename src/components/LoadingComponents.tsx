...
export const LoadingCard: React.FC<LoadingCardProps> = ({
  ...
  return (
    <motion.div
      {...ANIMATIONS.slideUp}
      className={`bg-white dark:bg-gray-800 rounded-md shadow-none border border-gray-200 dark:border-gray-700 p-4 md:p-6 ${className}`}
    >
      {/* Header con icono */}
      {showIcon && (
...
export const LoadingTable: React.FC<LoadingTableProps> = ({
  ...
  return (
    <motion.div
      {...ANIMATIONS.fadeIn}
      className={`bg-white dark:bg-gray-800 rounded-md shadow-none border border-gray-200 dark:border-gray-700 overflow-hidden ${className}`}
    >
      {/* Header */}
  ...
  return (
    ...
    >
      ...
      <div className="h-64 flex items-end justify-center space-x-2">
        ...
        {type === "pie" && <Skeleton className="w-40 h-40 rounded-full" />}

        {type === "line" && <Skeleton className="w-full h-32" />}
      </div>
    </motion.div>
  );
};
