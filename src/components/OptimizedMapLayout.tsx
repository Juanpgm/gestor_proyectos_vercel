    ...
    >
      <div className="flex h-full">
        ...
        <motion.div
          ...
          className="bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col h-full"
        >
          {leftPanelOpen && (
            <div className="h-full flex flex-col">
              {/* Header compacto - altura fija */}
              <div className="flex-shrink-0 p-2 border-b border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800">
              ...
              {/* Control de Capas - ocupa el espacio restante */}
              ...
              {/* Panel de Propiedades - altura variable según contenido */}
              {selectedFeature && (
                <div className="flex-shrink-0 border-t border-gray-200 dark:border-gray-700 max-h-60 min-h-0 overflow-y-auto">
                  <div className="p-2 bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="text-gray-400 hover:text-gray-600 text-xs p-1 hover:bg-gray-200 dark:hover:bg-gray-700 rounded"
                      >
                        ✕
                      </button>
                    </div>
