...
const SymbologyDiagnostics: React.FC<SymbologyDiagnosticsProps> = ({
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 mb-4">
      ...
      <dl className="space-y-2">
        {diagnostics.map((item, index) => (
          <article key={index} className="flex items-center justify-between text-xs">
      ...
      {layerData && (
        <footer className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
