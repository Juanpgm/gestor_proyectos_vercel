...
const ProcesosEmprestitoTable: React.FC = () => {
  ...
  const [procesoToDelete, setProcesoToDelete] =
    useState<ProcesoEmprestito | null>(null);
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      const {
        ...
        procesoToDelete as Record<string, any>,
        referencia,
      );
    ...
    try {
      ...
      const nombresBancos = Array.isArray(data)
        ? (Array.from(
            new Set(
              data
                .map((asignacion: any) => asignacion.nombre_banco)
                .filter(Boolean),
            ),
          ) as string[])
        : [];
  ...
  const handleSubmitProceso = async () => {
    ...
    const camposFaltantes = camposRequeridos.filter(
      (campo) => !nuevoProceso[campo as keyof NuevoProceso],
    );
    ...
    try {
      ...
      if (
        nuevoProceso.nombre_resumido_proceso &&
        nuevoProceso.nombre_resumido_proceso.trim()
      ) {
        procesoData.nombre_resumido_proceso =
          nuevoProceso.nombre_resumido_proceso.trim();
      }
      ...
      if (
        nuevoProceso.valor_proyectado &&
        nuevoProceso.valor_proyectado.trim()
      ) {
        const valorNumerico = parseFloat(
          nuevoProceso.valor_proyectado.replace(/[^\d.-]/g, ""),
        );
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div className="relative centro-gestor-dropdown">
                      ...
                      <div className="relative">
                        <div
                          ...
                          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 dark:text-white cursor-pointer flex items-center justify-between text-sm"
                        >
                          <span
                            className={
                              nuevoProceso.nombre_centro_gestor
                          ...
                          <ChevronDown
                            className={`h-4 w-4 text-gray-400 transition-transform ${showCentrosDropdown ? "rotate-180" : ""}`}
                          />
                        </div>
                            ...
                            >
                              ...
                              <div className="p-2 border-b border-gray-200 dark:border-gray-700">
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) =>
                                      setCentroGestorSearch(e.target.value)
                                    }
                              ...
                              <div className="max-h-52 overflow-y-auto">
                                {loadingCentros ? (
                                  ...
                                  filteredCentrosGestores.map(
                                    (centro, index) => (
                                      <div
                                        key={index}
                                        onClick={() =>
                                          selectCentroGestor(centro)
                                        }
                    ...
                    <div className="banco-dropdown">
                      ...
                      <div className="relative">
                        <div
                          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white text-sm cursor-pointer flex items-center justify-between"
                          onClick={() =>
                            setShowBancosDropdown(!showBancosDropdown)
                          }
                        >
                          <span
                            className={
                              nuevoProceso.nombre_banco
                                ? "text-gray-900 dark:text-white"
                                : "text-gray-500 dark:text-gray-400"
                            }
                          >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleInputChange("plataforma", e.target.value)
                        }
                        required
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white text-sm"
                      >
                        ...
                        <option value="Tienda Virtual del Estado Colombiano">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("id_paa", e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("valor_proyectado", e.target.value)
                        }
                        placeholder="0"
                        min="0"
                        step="0.01"
                  ...
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => handleSort("proceso_numero")}
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      <div className="flex items-center gap-2">
                        <span>Banco</span>
                        <button
                          onClick={() => handleSort("entidad_compradora")}
                          className="hover:bg-gray-200 dark:hover:bg-gray-600 p-1 rounded"
                        >
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      <div className="flex items-center gap-2">
                        <span>Estado</span>
                        <button
                          onClick={() => handleSort("estado_proceso")}
                          className="hover:bg-gray-200 dark:hover:bg-gray-600 p-1 rounded"
                        >
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() =>
                            handleSort("proceso_presupuesto_estimado")
                          }
                          className="hover:bg-gray-200 dark:hover:bg-gray-600 p-1 rounded"
                        >
                      ...
                      <td className="px-6 py-4 text-right text-sm font-medium text-teal-600 dark:text-teal-400 whitespace-nowrap">
                        {proceso.proceso_presupuesto_estimado
                          ? new Intl.NumberFormat("es-CO", {
                            ...
                            }).format(proceso.proceso_presupuesto_estimado)
                          : "N/A"}
                      </td>
              ...
              >
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-6">
                    ...
                    <strong>{resolveProcesoReferencia(procesoToDelete)}</strong>
                    ?
                    <br />
                    <br />
                    <span className="text-sm text-red-500 dark:text-red-400 font-medium">
                      Esta acción no se puede deshacer. Se eliminará de ambas
                      colecciones (SECOP y TVEC).
                    </span>
                  </p>
