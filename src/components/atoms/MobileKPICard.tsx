...
const colorMap: Record<
  ColorName,
  { bg: string; iconBg: string; text: string; number: string }
> = {
  blue: {
...
function CardContent({
  ...
  icon,
  color,
}: Omit<MobileKPICardProps, "href" | "className">) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "text-2xl font-semibold tabular-nums leading-none mb-1 tracking-tight",
          c.number,
        )}
      >
        {value === null ? (
