...
export const metadata: Metadata = {
  ...
  description:
    "Plataforma analítica de gestión de proyectos — Alcaldía de Cali",
};
      ...
      >
        <div className="flex items-center gap-2.5">
          <div className="w-6 h-6 rounded-sm bg-sky-400/20 border border-sky-400/40 flex items-center justify-center shrink-0">
            <span className="text-sky-300 text-[10px] font-bold leading-none select-none">
              CT
            </span>
          </div>
          <div className="flex flex-col">
            <span className="text-white text-[13px] font-semibold leading-tight tracking-tight">
              CaliTrack
            </span>
