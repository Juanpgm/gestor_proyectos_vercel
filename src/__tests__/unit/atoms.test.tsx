...
describe('Badge', () => {
  ...
  it('renders dot indicator when dot=true', () => {
    const { container } = render(<Badge color="blue" dot>Estado</Badge>)
...
describe('Input', () => {
  ...
  it('fires onChange events', () => {
    ...
    fireEvent.change(screen.getByRole('textbox'), { target: { value: 'CaliTrack' } })
...
describe('MobileKPICard', () => {
  ...
  it('renders label', () => {
    render(<MobileKPICard label="Proyectos" value={42} icon={icon} color="blue" />)
    expect(screen.getByText('Proyectos')).toBeInTheDocument()
  })

  it('renders numeric value formatted', () => {
    render(<MobileKPICard label="Contratos" value={1234} icon={icon} color="violet" />)
    // es-CO locale: 1.234
  ...
  it('renders loading skeleton when value is null', () => {
    const { container } = render(
      <MobileKPICard label="Actividades" value={null} icon={icon} color="red" />
    )
  ...
  it('renders as a link when href is provided', () => {
    render(
      <MobileKPICard label="Proyectos" value={10} icon={icon} color="blue" href="/m/proyectos" />
    )
