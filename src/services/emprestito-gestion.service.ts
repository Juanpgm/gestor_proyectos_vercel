...
export const fetchEmprestitoQualityStats = (params?: Record<string, string>) =>
  proxyGet<any>("emprestito/quality-control/stats", params);

/** POST /emprestito/quality-control/analyze — Generar análisis de calidad */
export const analyzeEmprestitoQuality = (params?: Record<string, string>) =>
...
export const fetchResumenCentroGestor = (params?: Record<string, string>) =>
...
export const fetchHistorialCambios = (params?: Record<string, string>) =>
...
export const crearSolicitudCambioContrato = (
  data: SolicitudCambioContratoPayload,
) =>
...
export const crearSolicitudCambioProceso = (
  data: SolicitudCambioProcesoPayload,
) =>
  crearSolicitudCambioEmprestito({
...
export const fetchSolicitudesCambiosEmprestito = async (
  ...
  const res = await proxyGet<any>("solicitudes_cambios_emprestito", {
    limit: "500",
    ...params,
  });
  return Array.isArray(res?.data) ? res.data : Array.isArray(res) ? res : [];
...
export const modificarProcesoEmprestito = (
  refProceso: string,
  data: Record<string, any>,
) =>
  proxyPut("emprestito/modificar-proceso", {
    referencia_proceso: refProceso,
    ...data,
  });
...
export const modificarContratoEmprestito = (
  ...
  proxyPut("emprestito/modificar-contrato", {
...
export const modificarOrdenCompraEmprestito = (
  ...
  proxyPut("emprestito/modificar-orden-compra", {
    numero_orden: numOrden,
    ...data,
  });

/** PUT /emprestito/modificar-convenio-transferencia (body: doc_id + campos) */
export const modificarConvenioEmprestito = (
  docId: string,
  data: Record<string, any>,
) =>
  proxyPut("emprestito/modificar-convenio-transferencia", {
    doc_id: docId,
    ...data,
  });

/** PUT /emprestito/modificar-rpc (form: numero_rpc + datos_actualizacion JSON) */
export const modificarRPCEmprestito = (
  numRpc: string,
  data: Record<string, any>,
) =>
  proxyPut("emprestito/modificar-rpc", {
    numero_rpc: numRpc,
    datos_actualizacion: JSON.stringify(data),
  });
...
export const aprobarSolicitudEmprestito = async (
  ...
  return proxyPut(
    `solicitudes_cambios_emprestito/${encodeURIComponent(solicitudId)}/aprobar`,
    {},
  );
};
...
export const rechazarSolicitudEmprestito = async (
  ...
  return proxyPut(
    `solicitudes_cambios_emprestito/${encodeURIComponent(solicitudId)}/rechazar`,
    {
